...
st.markdown("Carga tu archivo `HR-Employee-Attrition.csv` para ejecutar el pipeline completo.")
...
if uploaded_file:
    ...
    with tabs[4]:
        ...
        c1, c2, c3 = st.columns(3)
        c1.metric("Filas antes", filas_antes)
        c2.metric("Filas después", filas_despues_outliers)
        c3.metric("Eliminadas", filas_antes - filas_despues_outliers)
